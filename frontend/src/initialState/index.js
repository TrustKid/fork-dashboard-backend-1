...
import CategoryProject from "../Screens/CategoryProject";
...
import DeadprojectIcon from '../Components/Icons/DeadprojectIcon';
import HotprojectIcon from '../Components/Icons/HotprojectIcon';
import FeaturedprojectIcon from '../Components/Icons/FeaturedprojectIcon';
// import PostedprojectIcon from '../Components/Icons/PostedprojectIcon';
...
export const menuList = [
  {
    link: '', component: <Dashboard />, label: 'Dashboard', brightImage: <DashboardIcon color={'#121212'} />, darkImage: <DashboardIcon color={'#ededed'} />
  },
  {
    link: 'featuredProject', component: <CategoryProject />, label: 'Featured Project', brightImage: <FeaturedprojectIcon color={'#121212'} />, darkImage: <FeaturedprojectIcon color={'#ededed'} />
  },
  { link: 'hotProjectList', component: <CategoryProject />, label: 'Hot Project', brightImage: <HotprojectIcon color={'#121212'} />, darkImage: <HotprojectIcon color={'#ededed'} /> },
  // {link:'', component: undefined, label: 'Charts', brightImage: <ChartIcon color={'#121212'}/>, darkImage:<ChartIcon color={'#ededed'}/>, 
  //     submenu:[
  //         {link:'chart/power_nodes', component: <Chart/>, label: 'Power nodes',brightImage:'../images/icons/info_black.png'},
  //         {link:'chart/thor', component: <Chart/>, label: 'Thor',brightImage:'../images/icons/info_black.png'},
  //         {link:'chart/wonderland', component: <Chart/>, label: 'Wonderland',brightImage:'../images/icons/info_black.png'},
  //         {link:'chart/hector_dao', component: <Chart/>, label: 'Hector Dao',brightImage:'../images/icons/info_black.png'},
  //         {link:'chart/olympus', component: <Chart/>, label: 'Olympus',brightImage:'../images/icons/info_black.png'},
  //     ]},
  {
    link: '', component: undefined, label: 'Networks', brightImage: <NetworkIcon color={'#121212'} />, darkImage: <NetworkIcon color={'#ededed'} />,
    submenu: [
      { link: 'networks/bsc', component: <CategoryProject />, label: 'BSC', brightImage: '../images/icons/info_black.png' },
      { link: 'networks/fantom', component: <CategoryProject />, label: 'Fantom', brightImage: '../images/icons/info_black.png' },
      { link: 'networks/avax', component: <CategoryProject />, label: 'Avax', brightImage: '../images/icons/info_black.png' },
      { link: 'networks/polygon', component: <CategoryProject />, label: 'Polygon', brightImage: '../images/icons/info_black.png' },
      { link: 'networks/ethereum', component: <CategoryProject />, label: 'Ethereum', brightImage: '../images/icons/info_black.png' },
    ]
  },
  { link: 'upcomingProject', component: <CategoryProject />, label: 'Upcoming Project', brightImage: <UpcomingIcon color={'#121212'} />, darkImage: <UpcomingIcon color={'#ededed'} /> },
  { link: 'whitelists', component: <WhiteList />, label: 'Whitelists', brightImage: <WhitelistIcon color={'#121212'} />, darkImage: <WhitelistIcon color={'#ededed'} /> },
  { link: 'rugs', component: <CategoryProject />, label: 'Rugs', brightImage: <DashboardIcon color={'#121212'} />, darkImage: <DashboardIcon color={'#ededed'} /> },

  { link: 'deadProject', component: <CategoryProject />, label: 'Dead Project', brightImage: <DeadprojectIcon color={'#121212'} />, darkImage: <DeadprojectIcon color={'#ededed'} /> },
  // {link:'user_profile', component: <Dashboard/>, label: 'User Profile', brightImage: <UserprofileIcon color={'#121212'}/>, darkImage:<UserprofileIcon color={'#ededed'}/>},
  // {link:'posted_project', component: <CategoryProject/>, label: 'Posted Project', brightImage: <PostedprojectIcon color={'#121212'}/>, darkImage:<PostedprojectIcon color={'#ededed'}/>},
  { link: 'watchlist', component: <CategoryProject />, label: 'Watchlist', brightImage: <WatchlistIcon color={'#121212'} />, darkImage: <WatchlistIcon color={'#ededed'} /> }
]

export const adminMenu = [
  { link: '', component: <Projects />, label: 'Project management', brightImage: <NetworkIcon color={'#121212'} />, darkImage: <NetworkIcon color={'#ededed'} /> },

  { link: 'users', component: <Projects />, label: 'User management', brightImage: <UpcomingIcon color={'#121212'} />, darkImage: <UpcomingIcon color={'#ededed'} /> },
  { link: 'category', component: <Category />, label: 'Category management', brightImage: <FeaturedprojectIcon color={'#121212'} />, darkImage: <FeaturedprojectIcon color={'#ededed'} /> },
  { link: 'whitelist', component: <Category />, label: 'Whitelist', brightImage: <WhitelistIcon color={'#121212'} />, darkImage: <WhitelistIcon color={'#ededed'} /> },
  // {link:'/admin/', component: <Admin/>, label: 'Admin_projects', brightImage: <WhitelistIcon color={'#121212'}/>, darkImage:<DashboardIcon color={'#ededed'}/>},
...
export const social_inks = [
  { title: 'Twitter', white_image: '../images/icons/twitter_white_footer.png', black_image: '../images/icons/twitter_black_footer.png', link: 'https://www.twitter.com' },
  { title: 'Discord', white_image: '../images/icons/discord_white_footer.png', black_image: '../images/icons/discord_black_footer.png', link: 'https://www.discord.com' },
  { title: 'Youtube', white_image: '../images/icons/youtube_white_footer.png', black_image: '../images/icons/youtube_black_footer.png', link: 'https://www.youtube.com' },
  { title: 'Telegram', white_image: '../images/icons/telegram_white_footer.png', black_image: '../images/icons/telegram_black_footer.png', link: 'https://www.telegram.com' },
  { title: 'Email', white_image: '../images/icons/email_white_footer.png', black_image: '../images/icons/email_black_footer.png', link: 'https://www.gmail.com' },
]
