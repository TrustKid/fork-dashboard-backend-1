    ...
    return(
        <div className="project-item" style={{backgroundColor:props.bgcolor}}>
            <div className="d-flex">
                <img className="project-item-image" src={props.data.image}/>
                <div className="d-flex project-item-text-div">
                    <p className="project-item-text" style={{color:props.color}}>{props.data.forkName}</p>
        ...
        <div className="fear-card" 
            ...
            <div className="card-body">
                <div className="d-flex project-card-title">
                    ...
                    <svg style={{color:setTheme=='brightness'?Bright_Theme.fontColor_3:Dark_Theme.fontColor_3}} stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="stroke-current text-gray-500 dark:text-gray-400 ml-auto" height="28" width="28" xmlns="http://www.w3.org/2000/svg">
